...
- [make-fetch-happen](#make-fetch-happen)
  ...
  - [Table of Contents](#table-of-contents)
    ...
    - [API](#api)
      - [ `> fetch(uriOrRequest, [opts]) -> Promise<Response>`](#--fetchuriorrequest-opts---promiseresponse)
        - [Example](#example-1)
      - [ `> fetch.defaults([defaultUrl], [defaultOpts])`](#--fetchdefaultsdefaulturl-defaultopts)
        - [Example](#example-2)
      - [ `> minipass-fetch options`](#--minipass-fetch-options)
      - [ `> make-fetch-happen options`](#--make-fetch-happen-options)
      - [ `> opts.cachePath`](#--optscachepath)
        - [Example](#example-3)
      - [ `> opts.cache`](#--optscache)
        - [Example](#example-4)
      - [ `> opts.proxy`](#--optsproxy)
        - [Example](#example-5)
      - [ `> opts.noProxy`](#--optsnoproxy)
      - [ `> opts.ca, opts.cert, opts.key, opts.strictSSL`](#--optsca-optscert-optskey-optsstrictssl)
      - [ `> opts.localAddress`](#--optslocaladdress)
      - [ `> opts.maxSockets`](#--optsmaxsockets)
      - [ `> opts.retry`](#--optsretry)
        - [Example](#example-6)
      - [ `> opts.onRetry`](#--optsonretry)
        - [Example](#example-7)
      - [ `> opts.integrity`](#--optsintegrity)
        - [Example](#example-8)
      - [ `> opts.dns`](#--optsdns)
